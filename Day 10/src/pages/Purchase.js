    ...
    <>
      <body id="whole">
        <div id="container">
          ...
          <Link to="/addPurchase"><button id="addbtn">Add Purchases</button></Link>
            ...
            <thead>
              <tr>
                ...
                <th style={{ backgroundColor: "rgb(155, 200, 202)" }} onClick={() => handleSort('name')}>
                  Supplier Contact No{sortBy === 'name' && (sortOrder === 'asc' ? '▲' : '▼')}
                </th>
                <th style={{ backgroundColor: "rgb(155, 200, 202)" }} onClick={() => handleSort('name')}>
                ...
                <th style={{ backgroundColor: "rgb(155, 200, 202)" }} onClick={() => handleSort('name')}>
                  Date{sortBy === 'name' && (sortOrder === 'asc' ? '▲' : '▼')}
                </th>
                <th style={{ backgroundColor: "rgb(155, 200, 202)" }} onClick={() => handleSort('name')}>
                  Rate{sortBy === 'name' && (sortOrder === 'asc' ? '▲' : '▼')}
                </th>
